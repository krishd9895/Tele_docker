...
async def cmd_welcome_menu(message: Message):
    menu_text = (
        ...
        "• /zrok_bootstrap - Full automated zrok2 server setup\n"
        "• /zrok_services - Start/stop zrok2 systemd services\n"
        "• /zrok_setup - Install/enroll zrok2 + update DuckDNS\n"
        "• /zrok_install_local - Install zrok2 from local .tar.gz\n"
        "• /expose - Wizard: expose a local port via zrok2\n"
