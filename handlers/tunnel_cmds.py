...
async def cb_cf_guide(call: CallbackQuery):
    ...
    await call.message.answer(
        "📋 <b>Cloudflare Permanent Tunnel — Step by Step</b>\n\n"
        "━━━━━━━━━━━━━━━━━━━━━━━━\n"
        "<b>Step 1 — Sign up (free)</b>\n"
        "Open <code>cloudflare.com</code> on your phone\n"
        "Tap <b>Sign Up</b> → enter email + password → verify email\n\n"

        "<b>Step 2 — Open Zero Trust</b>\n"
        "After login → left sidebar → <b>Zero Trust</b>\n"
        "First time? It asks for a team name — type anything (e.g. <code>myteam</code>)\n"
        "Choose the <b>Free plan</b> → click Done\n\n"

        "<b>Step 3 — Create a tunnel</b>\n"
        "In Zero Trust dashboard:\n"
        "→ Left menu: <b>Networks</b>\n"
        "→ Click <b>Tunnels</b>\n"
        "→ Click <b>Create a tunnel</b>\n"
        "→ Select <b>Cloudflared</b> → click Next\n"
        "→ Type a name for your tunnel (e.g. <code>myserver</code>)\n"
        "→ Click <b>Save tunnel</b>\n\n"

        "<b>Step 4 — Get your token</b>\n"
        "On the next page it shows an install command.\n"
        "You will see something like:\n"
        "<code>cloudflared service install eyJhIjoi...</code>\n\n"
        "👉 <b>Copy ONLY the long string after <code>install</code></b>\n"
        "It starts with <code>eyJ</code> and is very long.\n"
        "That is your token. Copy it.\n\n"
        "⚠️ Do NOT run that command yourself — the bot will do it.\n\n"

        "<b>Step 5 — Add your public URL</b>\n"
        "After copying the token, scroll down on the same page\n"
        "You will see <b>Next: Route tunnel</b> — click it\n\n"
        "Under <b>Public Hostname</b>:\n"
        "• <b>Subdomain:</b> type what you want, e.g. <code>app</code>\n"
        "• <b>Domain:</b> select your domain from dropdown\n"
        "  (If you don't have one, see note below)\n"
        "• <b>Service Type:</b> select <b>HTTP</b> from the dropdown\n"
        "• <b>URL:</b> <code>localhost:8080</code>\n"
        "  ⚠️ Just <code>localhost:8080</code> — no http:// prefix\n"
        "  Change 8080 to whatever port your app runs on\n"
        "→ Click <b>Save tunnel</b>\n\n"

        "✅ Your permanent URL will be: <code>app.yourdomain.com</code>\n\n"

        "<b>Step 6 — Paste token in bot</b>\n"
        "Come back here → /expose_perm\n"
        "→ Tap <b>🔑 I have a token</b>\n"
        "→ Paste the token you copied\n"
        "→ Bot starts the tunnel — URL is live immediately\n\n"

        "━━━━━━━━━━━━━━━━━━━━━━━━\n"
        "📌 <b>Don't have a domain?</b>\n"
        "You can use Cloudflare's free subdomain:\n"
        "• In the Domain dropdown look for <code>*.workers.dev</code>\n"
        "• Your URL will be: <code>app.yourteam.workers.dev</code>\n"
        "• Still permanent and free!\n\n"

        "📌 <b>Have a domain elsewhere (like DuckDNS)?</b>\n"
        "DuckDNS domains cannot be added to Cloudflare.\n"
        "But you can add any domain you own to Cloudflare for free\n"
        "(GoDaddy, Namecheap etc.) by changing nameservers.",
        parse_mode="HTML"
    )
